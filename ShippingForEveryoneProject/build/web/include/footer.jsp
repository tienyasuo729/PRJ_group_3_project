    ...
    <section class="footer-2">
        <footer class="container footer-2-container  d-flex align-items-center">
            <div class="col-md-4 d-flex justify-content-center justify-content-md-start">
                <p class="footer2-paragraph">© 2023 Convinient Delivery. All rights reserved.</p>
            </div>
            ...
            <div class="col-md-4">
                <p class="footer2-paragraph d-flex justify-content-center justify-content-md-end">Sponsor By:FPT University<a href="https://daihoc.fpt.edu.vn/" class="text-white templatesjungle" target="_blank"> <u> 
                        </u> </a></p>
            </div>
        </footer>
    </section>
