...
<body>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <c:set var="c" value="${requestScope.orderShipping}" />
            <div class="card-body">
                <form action="update" method="post" >
                    <div class="form-group">
                        <label for="sender">Sender ID:</label>
                        <input type="text" value="${sessionScope.loginSession.getIdAccount()}" class="form-control" id="sender" name="sender" readonly required>
                    </div>
                    <div class="form-group">
                        <label for="receiverName">Receiver Name:</label>
                        <input type="text" class="form-control" id="receiverName" name="receiverName " value="${orderShipping.receiverName}" >
                    </div>
                    <div class="form-group">
                        <label for="receiverPhoneNum">Receiver Phone Number:</label>
                        <input type="text" class="form-control" id="receiverPhoneNum" name="receiverPhoneNum" value="${orderShipping.receiverPhoneNum}">
                    </div>
                    <div class="form-group">
                        <label for="collectionMoney">Collection Money:</label>
                        <input type="text" class="form-control" id="collectionMoney" name="collectionMoney" value="${orderShipping.collectionMoney}">
                    </div>                 
                    <div class="form-group">
                        <label for="city">City:</label>
                        <select class="form-control" id="city"  name="city" value="${orderShipping.address.city}" required  onchange="updateDistricts()">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="district" name="district" value="${orderShipping.address.district}" required onchange="updateWards()">
                            <!-- Options will be dynamically added based on the selected city -->
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="ward">Ward:</label>
                        <select class="form-control" id="ward" name="ward" value="${orderShipping.address.ward}"  required>
                            <!-- Options will be dynamically added based on the selected district -->
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="streetName">Street Name:</label>
                        <input type="text" class="form-control" id="streetName" name="streetName" value="${orderShipping.address.streetName}" required>
                    </div>
                    <div class="form-group">
                        <label for="apartmentNumber">Apartment Number:</label>
                        <input type="text" class="form-control" id="apartmentNumber" name="apartmentNumber" value="${orderShipping.address.apartmentNumber}" required>
                    </div>
                    <div class="form-group">
                        <label for="noteForShipper">Note for Shipper:</label>
                        <textarea class="form-control" id="noteForShipper" name="noteForShipper" value="${orderShipping.noteForShipper}" rows="3"></textarea>
                    </div>                                                    
