                ...
                <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden center">
                    ...
                    <div class="card-body p-2 p-sm-3">
                        ...
                        <form action="loginServlet" method="post">
                            ...
                            <div>
                                <input type="radio" class="btn-check" name="role" value="user" id="userRadio" autocomplete="off" checked>
                                <label class="btn btn-outline-success" for="userRadio">User</label>
                                <input type="radio" class="btn-check" name="role" value="shipper" id="shipperRadio" autocomplete="off">
                                <label class="btn btn-outline-danger" for="shipperRadio">Shipper</label>
                            </div>
                            ...
                            <a class="d-block text-center mt-2 small" href="signUpForUser.jsp">Don't have an account?
                                Sign Up</a>
                            <br/>
                            <hr class="my-2">
                            <br/>
