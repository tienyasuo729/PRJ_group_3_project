...
public class addOrderShipping extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addOrderShipping</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addOrderShipping at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setCharacterEncoding("UTF-8");
        ...
        try {
            ...
            OrderShipping ordershipping = new OrderShipping(senderId, collectionMoney, checkPackage,address, noteForShipper, receiverName, receiverPhoneNum, idDelivery);
